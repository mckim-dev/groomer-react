  ...
  return (
    <li className="px-3 py-3 flex items-start">
      <div className="flex-grow">
        ...
        <div className="flex items-center">
          <span className="flex-none font-medium text-lg text-[#007890]"><b>Owner: </b>{appointment.ownerName}</span>
          <span className="flex-grow text-right text-[#007890]">{appointment.email}</span>
        </div>
        <div><b className="font-bold text-[#007890] leading-tight">Grooming Needs:</b> {appointment.aptServices}</div>
      </div>
